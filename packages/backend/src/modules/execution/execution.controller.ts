...
export class ExecutionController {
  ...
  executeWorkflow(@Param('id') id: string, @Request() req) {
    return this.executionService.executeWorkflow(id, req.user.userId);
  }
  ...
  executeNode(
    ...
    return this.executionService.executeNode(id, nodeKey, req.user.userId);
  }

  @Post(':id/nodes/:nodeKey/approve')
  approveNode(@Param('id') id: string, @Param('nodeKey') nodeKey: string, @Request() req) {
    return this.executionService.approveNode(id, nodeKey, req.user.userId);
  }
